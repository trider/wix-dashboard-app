...
const ProductPackagingFeesPlugin: FC = () => {
  ...
  const updateCheckout = async (
    ...
    const response = await httpClient.fetchWithAuth(
      ...
      }/additional-fees/calculate/calculateAdditionalFees`,
      {
        method: "POST",
        body: JSON.stringify({
          name: "wrapping",
  ...
  const calculateFees = async (id: string) => {
    const response:any = await httpClient.fetchWithAuth(
      `${
        import.meta.env.BASE_API_URL}/additional-fees/calculate/calculateAdditionalFees`,
      {
        method: "POST",
        body: JSON.stringify({
          name: "wrapping",
    ...
    return calculateFees(id, payload, payloadOptions);
  ...
  const createCheckout = async (options: checkout.CreateCheckoutOptions) => {
    ...
    return addToCheckout(response._id);
  };
