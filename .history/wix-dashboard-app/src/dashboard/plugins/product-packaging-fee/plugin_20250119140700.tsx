...
const ProductPackagingFeesPlugin: FC = () => {
  ...
  const [searchQuery, setSearchQuery] = useState<string>("");
    ...
    const caluclateFees = async (id:string, additionalFees:additionalFees.CalculateAdditionalFeesRequest,updateCheckout:checkout.UpdateCheckout, options:checkout.UpdateCheckoutOptions) => {
    ...
    const addToCheckout = async (id:string, options:checkout.AddToCheckoutOptions) => {
      ...
      const additionalFees:additionalFees.CalculateAdditionalFeesRequest = {
        "name": "wrapping",
      ...
      return caluclateFees(id,additionalFees, payload, payloadOptions)
